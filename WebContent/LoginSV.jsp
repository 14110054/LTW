      ...
      <form class="form-signin col-md-7 col-md-offset-3">
       <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <!--         <label class="radio-inline"><input type="radio" checked="checked" name="optradio"><a href="#" >Sinh viên</a></label> 
                      <label class="radio-inline"><input type="radio" name="optradio"> <a href="LoginGV.jsp" >Giảng viên</a> </label>
            ...
            <div class="col-sm-6">
                <form name="userForm" ng-submit="submitForm()" novalidate>
                  ...
                  <div class="col-md-5 col-md-offset-5">
	                 <button type="submit" name="submit" class="btn btn-default" ng-disabled="userForm.$invalid">Đăng nhập</button>
               ...
               Class.forName("com.mysql.jdbc.Driver");
                Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/do_an",
                    		            "root", "6796");
                    		    ...
                    		    if (rs.next()) 
                    		    {
                    		        ...
                    		        out.println("Sai password <a href='LoginSV.jsp'>try again</a>");
                    		    }
               }
                    		%>  
